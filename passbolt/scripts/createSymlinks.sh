...
FIREFOX_EXTENSION=`ls -v $PASSBOLT_EXTENSION_DIR/dist/firefox/passbolt-*-debug.xpi`
CHROME_EXTENSION=`ls -v $PASSBOLT_EXTENSION_DIR/dist/chrome/passbolt-*-debug.crx`

ln -sf $FIREFOX_EXTENSION $PASSBOLT_SELENIUM_DIR/data/extensions/passbolt-firefox-addon.xpi
