...
return array(
    'ChromeDriver' => $baseDir . '/lib/chrome/ChromeDriver.php',
    'ChromeDriverService' => $baseDir . '/lib/chrome/ChromeDriverService.php',
    'ChromeOptions' => $baseDir . '/lib/chrome/ChromeOptions.php',
    'DesiredCapabilities' => $baseDir . '/lib/remote/DesiredCapabilities.php',
    'DriverCommand' => $baseDir . '/lib/remote/DriverCommand.php',
    'DriverCommandExecutor' => $baseDir . '/lib/remote/service/DriverCommandExecutor.php',
    'DriverService' => $baseDir . '/lib/remote/service/DriverService.php',
    'ElementNotSelectableException' => $baseDir . '/lib/WebDriverExceptions.php',
    'ElementNotVisibleException' => $baseDir . '/lib/WebDriverExceptions.php',
    'EventFiringWebDriver' => $baseDir . '/lib/support/events/EventFiringWebDriver.php',
    'EventFiringWebDriverNavigation' => $baseDir . '/lib/support/events/EventFiringWebDriverNavigation.php',
    'EventFiringWebElement' => $baseDir . '/lib/support/events/EventFiringWebElement.php',
    'ExecuteMethod' => $baseDir . '/lib/remote/ExecuteMethod.php',
    'ExpectedException' => $baseDir . '/lib/WebDriverExceptions.php',
    'FileDetector' => $baseDir . '/lib/remote/FileDetector.php',
    'File_Iterator' => $vendorDir . '/phpunit/php-file-iterator/src/Iterator.php',
    'File_Iterator_Facade' => $vendorDir . '/phpunit/php-file-iterator/src/Facade.php',
    'File_Iterator_Factory' => $vendorDir . '/phpunit/php-file-iterator/src/Factory.php',
    'FirefoxDriver' => $baseDir . '/lib/firefox/FirefoxDriver.php',
    'FirefoxProfile' => $baseDir . '/lib/firefox/FirefoxProfile.php',
    'HttpCommandExecutor' => $baseDir . '/lib/remote/HttpCommandExecutor.php',
    'IMEEngineActivationFailedException' => $baseDir . '/lib/WebDriverExceptions.php',
    'IMENotAvailableException' => $baseDir . '/lib/WebDriverExceptions.php',
    'IndexOutOfBoundsException' => $baseDir . '/lib/WebDriverExceptions.php',
    'InvalidCookieDomainException' => $baseDir . '/lib/WebDriverExceptions.php',
    'InvalidCoordinatesException' => $baseDir . '/lib/WebDriverExceptions.php',
    'InvalidElementStateException' => $baseDir . '/lib/WebDriverExceptions.php',
    'InvalidSelectorException' => $baseDir . '/lib/WebDriverExceptions.php',
    'JavaScriptExecutor' => $baseDir . '/lib/JavaScriptExecutor.php',
    'LocalFileDetector' => $baseDir . '/lib/remote/LocalFileDetector.php',
    'MoveTargetOutOfBoundsException' => $baseDir . '/lib/WebDriverExceptions.php',
    'NoAlertOpenException' => $baseDir . '/lib/WebDriverExceptions.php',
    'NoCollectionException' => $baseDir . '/lib/WebDriverExceptions.php',
    'NoScriptResultException' => $baseDir . '/lib/WebDriverExceptions.php',
    'NoStringException' => $baseDir . '/lib/WebDriverExceptions.php',
    'NoStringLengthException' => $baseDir . '/lib/WebDriverExceptions.php',
    'NoStringWrapperException' => $baseDir . '/lib/WebDriverExceptions.php',
    'NoSuchCollectionException' => $baseDir . '/lib/WebDriverExceptions.php',
    'NoSuchDocumentException' => $baseDir . '/lib/WebDriverExceptions.php',
    'NoSuchDriverException' => $baseDir . '/lib/WebDriverExceptions.php',
    'NoSuchElementException' => $baseDir . '/lib/WebDriverExceptions.php',
    'NoSuchFrameException' => $baseDir . '/lib/WebDriverExceptions.php',
    'NoSuchWindowException' => $baseDir . '/lib/WebDriverExceptions.php',
    'NullPointerException' => $baseDir . '/lib/WebDriverExceptions.php',
    ...
    'RemoteExecuteMethod' => $baseDir . '/lib/remote/RemoteExecuteMethod.php',
    'RemoteKeyboard' => $baseDir . '/lib/remote/RemoteKeyboard.php',
    'RemoteMouse' => $baseDir . '/lib/remote/RemoteMouse.php',
    'RemoteTargetLocator' => $baseDir . '/lib/remote/RemoteTargetLocator.php',
    'RemoteTouchScreen' => $baseDir . '/lib/remote/RemoteTouchScreen.php',
    'RemoteWebDriver' => $baseDir . '/lib/remote/RemoteWebDriver.php',
    'RemoteWebElement' => $baseDir . '/lib/remote/RemoteWebElement.php',
    'ScriptTimeoutException' => $baseDir . '/lib/WebDriverExceptions.php',
    ...
    'SessionNotCreatedException' => $baseDir . '/lib/WebDriverExceptions.php',
    'StaleElementReferenceException' => $baseDir . '/lib/WebDriverExceptions.php',
    'Text_Template' => $vendorDir . '/phpunit/php-text-template/src/Template.php',
    'TimeOutException' => $baseDir . '/lib/WebDriverExceptions.php',
    'URLChecker' => $baseDir . '/lib/net/URLChecker.php',
    'UnableToSetCookieException' => $baseDir . '/lib/WebDriverExceptions.php',
    'UnexpectedAlertOpenException' => $baseDir . '/lib/WebDriverExceptions.php',
    'UnexpectedJavascriptException' => $baseDir . '/lib/WebDriverExceptions.php',
    'UnexpectedTagNameException' => $baseDir . '/lib/WebDriverExceptions.php',
    'UnknownCommandException' => $baseDir . '/lib/WebDriverExceptions.php',
    'UnknownServerException' => $baseDir . '/lib/WebDriverExceptions.php',
    'UnrecognizedExceptionException' => $baseDir . '/lib/WebDriverExceptions.php',
    'UnsupportedOperationException' => $baseDir . '/lib/WebDriverExceptions.php',
    'UselessFileDetector' => $baseDir . '/lib/remote/UselessFileDetector.php',
    'WebDriver' => $baseDir . '/lib/WebDriver.php',
    'WebDriverAction' => $baseDir . '/lib/WebDriverAction.php',
    'WebDriverActions' => $baseDir . '/lib/interactions/WebDriverActions.php',
    'WebDriverAlert' => $baseDir . '/lib/WebDriverAlert.php',
    'WebDriverBrowserType' => $baseDir . '/lib/remote/WebDriverBrowserType.php',
    'WebDriverButtonReleaseAction' => $baseDir . '/lib/interactions/internal/WebDriverButtonReleaseAction.php',
    'WebDriverBy' => $baseDir . '/lib/WebDriverBy.php',
    'WebDriverCapabilities' => $baseDir . '/lib/WebDriverCapabilities.php',
    'WebDriverCapabilityType' => $baseDir . '/lib/remote/WebDriverCapabilityType.php',
    'WebDriverClickAction' => $baseDir . '/lib/interactions/internal/WebDriverClickAction.php',
    'WebDriverClickAndHoldAction' => $baseDir . '/lib/interactions/internal/WebDriverClickAndHoldAction.php',
    'WebDriverCommand' => $baseDir . '/lib/remote/WebDriverCommand.php',
    'WebDriverCommandExecutor' => $baseDir . '/lib/WebDriverCommandExecutor.php',
    'WebDriverCompositeAction' => $baseDir . '/lib/interactions/WebDriverCompositeAction.php',
    'WebDriverContextClickAction' => $baseDir . '/lib/interactions/internal/WebDriverContextClickAction.php',
    'WebDriverCoordinates' => $baseDir . '/lib/interactions/internal/WebDriverCoordinates.php',
    'WebDriverCurlException' => $baseDir . '/lib/WebDriverExceptions.php',
    'WebDriverDimension' => $baseDir . '/lib/WebDriverDimension.php',
    'WebDriverDispatcher' => $baseDir . '/lib/WebDriverDispatcher.php',
    'WebDriverDoubleClickAction' => $baseDir . '/lib/interactions/internal/WebDriverDoubleClickAction.php',
    'WebDriverDoubleTapAction' => $baseDir . '/lib/interactions/touch/WebDriverDoubleTapAction.php',
    'WebDriverDownAction' => $baseDir . '/lib/interactions/touch/WebDriverDownAction.php',
    'WebDriverElement' => $baseDir . '/lib/WebDriverElement.php',
    'WebDriverEventListener' => $baseDir . '/lib/WebDriverEventListener.php',
    'WebDriverException' => $baseDir . '/lib/WebDriverExceptions.php',
    'WebDriverExpectedCondition' => $baseDir . '/lib/WebDriverExpectedCondition.php',
    'WebDriverFlickAction' => $baseDir . '/lib/interactions/touch/WebDriverFlickAction.php',
    'WebDriverFlickFromElementAction' => $baseDir . '/lib/interactions/touch/WebDriverFlickFromElementAction.php',
    'WebDriverHasInputDevices' => $baseDir . '/lib/WebDriverHasInputDevices.php',
    'WebDriverKeyDownAction' => $baseDir . '/lib/interactions/internal/WebDriverKeyDownAction.php',
    'WebDriverKeyUpAction' => $baseDir . '/lib/interactions/internal/WebDriverKeyUpAction.php',
    'WebDriverKeyboard' => $baseDir . '/lib/WebDriverKeyboard.php',
    'WebDriverKeys' => $baseDir . '/lib/WebDriverKeys.php',
    'WebDriverKeysRelatedAction' => $baseDir . '/lib/interactions/internal/WebDriverKeysRelatedAction.php',
    'WebDriverLocatable' => $baseDir . '/lib/internal/WebDriverLocatable.php',
    'WebDriverLongPressAction' => $baseDir . '/lib/interactions/touch/WebDriverLongPressAction.php',
    'WebDriverMouse' => $baseDir . '/lib/WebDriverMouse.php',
    'WebDriverMouseAction' => $baseDir . '/lib/interactions/internal/WebDriverMouseAction.php',
    'WebDriverMouseMoveAction' => $baseDir . '/lib/interactions/internal/WebDriverMouseMoveAction.php',
    'WebDriverMoveAction' => $baseDir . '/lib/interactions/touch/WebDriverMoveAction.php',
    'WebDriverMoveToOffsetAction' => $baseDir . '/lib/interactions/internal/WebDriverMoveToOffsetAction.php',
    'WebDriverNavigation' => $baseDir . '/lib/WebDriverNavigation.php',
    'WebDriverOptions' => $baseDir . '/lib/WebDriverOptions.php',
    'WebDriverPlatform' => $baseDir . '/lib/WebDriverPlatform.php',
    'WebDriverPoint' => $baseDir . '/lib/WebDriverPoint.php',
    'WebDriverResponse' => $baseDir . '/lib/remote/WebDriverResponse.php',
    'WebDriverScrollAction' => $baseDir . '/lib/interactions/touch/WebDriverScrollAction.php',
    'WebDriverScrollFromElementAction' => $baseDir . '/lib/interactions/touch/WebDriverScrollFromElementAction.php',
    'WebDriverSearchContext' => $baseDir . '/lib/WebDriverSearchContext.php',
    'WebDriverSelect' => $baseDir . '/lib/WebDriverSelect.php',
    'WebDriverSendKeysAction' => $baseDir . '/lib/interactions/internal/WebDriverSendKeysAction.php',
    'WebDriverSingleKeyAction' => $baseDir . '/lib/interactions/internal/WebDriverSingleKeyAction.php',
    'WebDriverTapAction' => $baseDir . '/lib/interactions/touch/WebDriverTapAction.php',
    'WebDriverTargetLocator' => $baseDir . '/lib/WebDriverTargetLocator.php',
    'WebDriverTimeouts' => $baseDir . '/lib/WebDriverTimeouts.php',
    'WebDriverTouchAction' => $baseDir . '/lib/interactions/touch/WebDriverTouchAction.php',
    'WebDriverTouchActions' => $baseDir . '/lib/interactions/WebDriverTouchActions.php',
    'WebDriverTouchScreen' => $baseDir . '/lib/interactions/WebDriverTouchScreen.php',
    'WebDriverUpAction' => $baseDir . '/lib/interactions/touch/WebDriverUpAction.php',
    'WebDriverWait' => $baseDir . '/lib/WebDriverWait.php',
    'WebDriverWindow' => $baseDir . '/lib/WebDriverWindow.php',
    'XPathLookupException' => $baseDir . '/lib/WebDriverExceptions.php',
);
