 ...
 *
 * Scenarios :
 *  - As a user I can edit a user using the edit button in the action bar
 *  - As a user I can edit a user using the right click contextual menu
 *  - As a user I can open close the edit user dialog
 *  - As a user I can see the edit user dialog
...
class UserEditTest extends PassboltTestCase {
	...
	/**
	 * Scenario: As a user I can edit a user using the right click contextual menu
	 *
	 * Given    I am Admin
	 * And      I am logged in on the user workspace
	...
	/**
	 * Scenario: As a user I can open close the edit user dialog
	 *
	 * Given    I am Admin
	 * And      I am logged in on the user workspace
	...
	/**
	 * Scenario: As a user I can see the edit user dialog
	 *
	 * Given    I am Admin
	...
	public function testEditUserDialogView() {
		...
		$this->assertVisible('.edit-user-dialog input[type=text]#js_field_first_name.required');
		$this->assertVisible('.edit-user-dialog label[for=js_field_first_name]');
		...
		$this->assertVisible('.edit-user-dialog input[type=text]#js_field_last_name.required');
		$this->assertVisible('.edit-user-dialog label[for=js_field_last_name]');

		// And I can see the user last name in the text input
		$this->assertInputValue('js_field_last_name', $user['LastName']);

		// And I can see the last name text input and label is marked as mandatory
		$this->assertVisible('.edit-user-dialog input[type=text]#js_field_username.required');
		$this->assertVisible('.edit-user-dialog input[type=text][disabled]#js_field_username');
		$this->assertVisible('.edit-user-dialog label[for=js_field_username]');

		// And I can see the user last name in the text input
		$this->assertInputValue('js_field_username', $user['Username']);

		// And I can see the save button
		$this->assertVisible('.edit-user-dialog input[type=submit].button.primary');

		// And I can see the cancel button
		$this->assertVisible('.edit-user-dialog a.cancel');
	}
