...
exports.config = {
    ...
    capabilities: [{
      ...
      acceptInsecureCerts: true,
      browserVersion: 'dev',
      'moz:firefoxOptions': {prefs: {'browser.helperApps.neverAsk.saveToDisk':   'text/anytext, text/plaintext'}}, // not showing download prompt
      'sauce:options': {screenResolution: '1600x1200'}
    }],
    //
    // ===================
    ...
    logLevel: 'warn', // In info too much logs due to the unpacked extension in base64 for firefox
    //
    ...
    baseUrl: `https://${process.env['BASE_URL_CE']}/`,
    //
    // Set a passbolt object config
    passbolt: {
      edition: 'ce' // edition to test CE or PRO version
    },
    //
    ...
    services: [['sauce', {
      sauceConnect: true,
      sauceConnectOpts: {
        tunnelIdentifier: process.env['SAUCELABS_USERNAME'] + '_tunnel_id',
      }
    }], ['firefox-profile',
