...
Class Image
{
    ...
    /**
     * Options can be :
     * self::COMP_COLOR || self::COMP_FRAGMENT || self::COMP_HASH
     *
     * @param Image $comp
     * @param int   $options
     *
     * @return int
     */
    public function difference(Image $comp, $options = self::COMP_COLOR)
    {
        // Hash compare
        ...
        if ($options & self::COMP_COLOR) {
            ...
            $deviation = 1 - ImageColor::avg($avgComp)->deviation(ImageColor::avg($avgOrg));
        }
