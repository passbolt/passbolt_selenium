...
trait ConfirmationDialogAssertionsTrait
{
    ...
    public function assertConfirmationDialog($title = '') 
    {
        ...
        $this->assertVisibleByCss('.dialog.confirm a.dialog-close');
        // Then I can see the cancel link.
        $this->assertVisibleByCss('.dialog.confirm a.cancel');
        // Then I can see the Ok button.
        $this->assertVisibleByCss('.dialog.confirm input#confirm-button');
        if ($title !== '') {
